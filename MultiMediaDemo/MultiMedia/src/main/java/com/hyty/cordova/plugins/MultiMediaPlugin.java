...
public class MultiMediaPlugin extends CordovaPlugin {
    private static MultiMediaPlugin mPlugin;// TODO:1
...
//        mActivity = super.cordova.getActivity();// todo:4
...
//                mMediaConfig.setParentUrl(mConfigParams.getUrlPathHeader());
    ...
    private void createPicDataAndResult(ArrayList<String> mList) {
        ...
        try {
            ...
            Timber.e(mE.getMessage());
            MobclickAgent.reportError(mActivity, "捕获的异常:" + mE.getMessage());
            if (mCallbackContext != null) mCallbackContext.error(mE.getMessage());
            return;
        }
